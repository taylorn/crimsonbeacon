...
class Case(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('case_detail', kwargs={'title': self.title.replace(' ', '-') })
    ...
    def get_update_url(self):
        return reverse('case_update', kwargs={'title': self.title.replace(' ', '-') })
    
    def get_delete_url(self):
        return reverse('case_delete', kwargs={'title': self.title.replace(' ', '-') })
